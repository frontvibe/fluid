...
export function useCardCssVars(props: {
  selector: string;
  ...
  return `
    ${props.selector} {
      --accent: ${getMutedColor(colorScheme.primary?.rgb, colorScheme.card?.rgb, 0.85)};
      --accent-foreground: ${toRgbString(colorScheme.primary?.rgb)};
      ...
      --primary: ${toRgbString(colorScheme.primary?.rgb)};
      --primary-foreground: ${toRgbString(colorScheme.primaryForeground?.rgb)};
      --ring: ${getMutedColor(colorScheme.primary?.rgb, colorScheme.card?.rgb, 0.2)};
      --secondary: ${getMutedColor(colorScheme.primary?.rgb, colorScheme.card?.rgb, 0.85)};
      --secondary-foreground: ${toRgbString(colorScheme.primary?.rgb)};
    }
  ` as const;
}
